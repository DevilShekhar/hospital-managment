                            ...
                            <tbody>
                                @forelse($appointments as $appointment)
                                    <tr>
                                        ...
                                        <td><strong>{{ $appointment->appointment_no ?? 'APT' . $appointment->id }}</strong></td>
                                        ...
                                        <td>
                                            {{ $appointment->department->name ?? ($appointment->department->department_name ?? '-') }}
                                        </td>
                                        ...
                                        <td>
                                            @if($appointment->doctor)
                                                Dr.
                                                {{ $appointment->doctor->first_name ? ($appointment->doctor->first_name . ' ' . ($appointment->doctor->last_name ?? '')) : $appointment->doctor->name }}
                                            @else
                                                -
                                            @endif
                                        </td>
